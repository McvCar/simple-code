module.exports = {
    ...
    'search-unused-assets': '在资源管理器高亮未使用的资源',
    ...
    'add-next-occurrence-node': '批量选中同名节点 (S)',
    'batch-search': '批量搜索|选中节点 (F)',
    'new-file-and-bind-node': '新建脚本绑定Node',
    'open-code': '打开代码|解锁编辑',
    ...
    'open-project-to-external-editor': '打开项目到外部编辑器',
    'open-project-in-creator': '打开项目到Creator',
