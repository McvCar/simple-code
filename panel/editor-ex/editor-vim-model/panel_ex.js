...
module.exports = {
	...
	// monaco 编辑器初始化
	onLoad(){
		vsVim 		= Editor.require('packages://simple-code/panel/editor-ex/editor-vim-model/vim/lib/index.js');
		this.isWait = false;
	...
	initVimMode(){
		...
		vsVim 		= vsVim || Editor.require('packages://simple-code/panel/editor-ex/editor-vim-model/vim/lib/index.js');;
